...
class LocationLocalDataSourceImplTest {
    ...
    @Test
    fun addFavorite_insertsLocation() = runBlocking {
    ...
    @Test
    fun removeFavorite_deletesLocation() = runBlocking {
        withContext(Dispatchers.IO) {
            val location = DatabasePojo(
                id = 1,
                Weather = createWeatherResponse(),
    ...
    @Test
    fun updateFavorite_updatesLocation() = runBlocking {
        withContext(Dispatchers.IO) {
            val location = DatabasePojo(
                id = 1,
                Weather = createWeatherResponse(),
    ...
    @Test
    fun getFavoriteLocations_returnsAllFavorites() = runBlocking {
        withContext(Dispatchers.IO) {
